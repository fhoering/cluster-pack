...
def test_upload_spec(mock_pack_spec_in_pex, mock_resolve_fs,
    ...
    mock_pack_spec_in_pex.assert_called_once_with(spec_file=spec_file, output=result_path)
    assert os.path.basename(result_path) == ("cluster-pack-"
